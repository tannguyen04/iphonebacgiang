 ...
 */
?>
<article id="node-<?php print $node->nid; ?>" class="box-product box-product-featured <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <div class="box-content"<?php print $content_attributes; ?>>
    <div class="box-content-top">
      ...
      <h2 class="box-product-featured--title node-title title" <?php print $title_attributes; ?>><a href="<?php print $node_url; ?>"><?php print $title ?></a></h2>
    ...
    <div class="box-content-bottom">
      <div class="box-product--price box-product-featured--price">
