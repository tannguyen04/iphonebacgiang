...
<div class="row portfoliowrap">
  <div id="isotope-container" class="portfolio isotope withsidebar">
    <?php $count = 0; ?>
    <?php foreach ( $rows as $id => $row ): ?>
      ...
      ?>
      <div class="entry isotope-element isotope-element-<?php print $count; ?> <?php print $classlist; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>>
