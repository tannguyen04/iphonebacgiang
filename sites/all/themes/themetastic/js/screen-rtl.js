jQuery(document).ready(function($) {
	...
	jQuery('.ddsmoothmenu ul ul ul:not(:last)').hover(function() {
		var $width = jQuery(this).width();
		$(this).css('margin-right', $width+'px');
	});
	
	jQuery('.ddsmoothmenu ul ul ul:last').hover(function() {
		var $width = jQuery(this).width();
		$(this).css('margin-right', -$width+'px');
	});
	...
	if (jQuery('.sticky-header').exists()) {
    	var $height = $('.headerwrap').height();
    	var $scrollHeight = $height - 10;
...
//				$('.headerwrap').stop().animate({height: $scrollHeight })
//	        } else {
//				$('.headerwrap').stop().animate({height: $height })
//	        }
	    });
