Introduction
------------
The RevolutionSlider Entities module provides a fully working yet generic example
...
Admnistration > Structure > RevolutionSlider Types

You can add revolution_slider entities via

Administration > Content > RevolutionSliders

Keep in mind that you need to create some RevolutionSlider Types before you can add entities.


Using the code in your projects
-------------------------------
The way I envision using the module in my own projects is, for the time being,
searching and replacing the word "revolution_slider" with the actual name I want to give my
...
Your would only every really need to change the RevolutionSlider entity and RevolutionSlider type as RevolutionSliderType
...
revolution_slider.admin.inc and customize the behaviour of your entity on save, delete which you
do via the RevolutionSliderController class in revolution_slider.module.
...
to your table)  - just like the revolution_slider entity does with the checkbox - there is nothing
else you need to do. If you have added new columns you need to add support for them
in $revolution_slider->create but not necessarily $revolution_slider->save unless you are doing something specific.

3. Finally you can play around within the theming for your entity by looking into revolution_slider.tpl.php and
revolution_slider-sample-data.tpl.php
